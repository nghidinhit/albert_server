...
from model.modeling_albert import BertForTokenClassification
...
class InputExample(object):
    ...
    def __init__(self, guid, text_a:str, text_b:str=None, label=None):
...
class NerProcessor(DataProcessor):
    ...
    def get_train_examples(self, data_dir: str) -> list:
        """See base class."""
        return self._create_examples(
            self._read_tsv(os.path.join(data_dir, "train.txt")), "train")

    def get_dev_examples(self, data_dir: str) -> list:
        """See base class."""
        return self._create_examples(
            self._read_tsv(os.path.join(data_dir, "valid.txt")), "dev")

    def get_test_examples(self, data_dir: str) -> list:
        """See base class."""
        return self._create_examples(
...
def main():
    ...
    logger.info('Tokenizer from pretrained')
